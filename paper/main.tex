...
Wasserstein-regularized path); (ii) under the literature-derived coupling,
the flow converges to near-uniform species densities, quantifying an
empirical constraint on the current choice of potentials; and (iii) a
...
$0.04$\,ms. The companion repository contains the full implementation,
